...
if __name__ == "__main__":
    ...
    # soapService.printService("cancelFlightReservation", 10701)
    # soapService.printService("cancelUserReservationInConcreteFlight", 11456)
    ...
    soapService.printService("getFlightAvailableSeats", 1025)
